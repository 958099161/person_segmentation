...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# parser.add_argument('-r', '--data_dir', default='E:\Oppo_Game\pytorch-semantic-segmentation-master/test_miou/real', metavar='DIR',
#                     help='path to image')
# parser.add_argument('-o', '--output', default='./test_miou/seg', metavar='DIR',
#                     help='path to output')
    ...
    with torch.no_grad():
        for name in tqdm(list_images):
            ...
            try:
                ...
                img_.save(args.output + '//' + name.split('.')[0] + 'erf300.png')
            except:
                print(name)
